...
-- transaction:false flag tells dbmate to run the migration outside of a transaction wrapper, which is required for CockroachDB when running DDL statements like CREATE TABLE, CREATE INDEX, etc.
